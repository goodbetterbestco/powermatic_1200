...
- `docs/Powermatic_1200_Retrofit_Documentation_rK.md` — design intent, power topology, sequence of operations, I/O assignments, VFD configuration, and safety architecture
- `docs/05_ladder_logic_rK.md` — CLICK PLUS ladder-logic source
- `docs/Powermatic_1200_Retrofit_Wire_Schedule_rK.md` — point-to-point build authority
- `docs/Powermatic_1200_SCCR_Worksheet_rK.md` — personal-shop SCCR due-diligence worksheet and field record
- `docs/05_ladder_logic_rK.pdf` — CLICK PLUS programming reference generated from the ladder source
- `docs/Powermatic_1200_Shop_Pack_rK.pdf` — power one-line, safety loop, VFD card, and commissioning checklists
- `docs/Powermatic_1200_Retrofit_BOM_rK.numbers` — owner-maintained procurement authority
- `docs/Powermatic_1200_Retrofit_BOM_rK.pdf` — frozen Rev K procurement snapshot
- `TODO.md` — open build and validation items

Local helper scripts for regenerating the PDFs live in `scripts/`.

Rev K is the controlled revision in this repository.

## Rev K safety and thermal basis
