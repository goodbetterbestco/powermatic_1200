...
*Revision K · 2026-08-06 · all-new wire · number each conductor at both ends (ferrule = wire no.)*

> **Rev K safety and thermal architecture.** The Dold
...
> isolation between the GS20's sink-mode DI4 circuit and the CLICK's sourcing input circuit. Rev K adds
...
> 2. **Contactor B tap now fused.** Rows 22/22A/24/24A route both 240 V legs through **KB-FU** (2× GMC3 in
...
> 3. **Fuse elements pinned (per BOM):** branch = 3× **TJN35** (Class T) in one LFT300603C 3-pole block with three LFT30060FBC pole covers · 24V-FU = **GMC5** ·
>    SR-FU = **GMC3** (spec was 2 A) · PSU-FU = 2× **GMC3** · KB-FU = 2× **GMC3** · DB-FU = **GMC1**. Blocks used: 7 of 10 DN-F10MN.
...
- **Terminal designations are typical** — verify against each device's own diagram (BH5928 S/Y terminals, GS20 STO/DI/DCM, LC1D18BD 13-14 N.O. and 21-22 mirror N.C., Phoenix relay A1+/A2- and 11/12/14, Phoenix timer A1/A2/B1 and 11/12/14).
...
| 20B | TDDB : A2 (-) | 0V bus | Timer supply return | BLU | 18 | Str |
...
| 20G | CRDB : A2 (-) | 0V bus | CR-DB polarized coil return; internal flywheel diode | BLU | 18 | Str |
...
| 79F1 | VFD : DCM | CRDB : 11 (COM) | DB-thermal force-stop sink common | BLU | 18 | Str |
...
| 86 | +24 bus | RED-M : X1 (+) (mach) | Machine-front red `FAULT / NOT READY` + | BLU | 18 | Str |
| 86A | +24 bus | RED-P : X1 (+) (door) | Enclosure-panel red `FAULT / NOT READY` + | BLU | 18 | Str |
| 87 | RED-M : X2 (-) (mach) | PLC : Y006 | Machine-front red return | BLU | 18 | Str |
| 87A | RED-P : X2 (-) (door) | PLC : Y006 | Panel red return; terminate with wire 87 in one 18 AWG twin ferrule | BLU | 18 | Str |
